...
├── RQ3_Preprocessing_Effect.ipynb       # Scaling strategies compared
├── RQ4_Feature_Importance.ipynb         # Random Forest feature importances
├── RQ5_Metrics_Sensitivity.ipynb        # Ranking across MAE / RMSE / R²
├── RQ6_Robustness.ipynb                 # CV folds & train-test split sensitivity
├── RQ7_Final_Recommendation.ipynb       # Full summary & final model choice
├── README.md
└── requirements.txt
```
